...
def cms_login():
    if 'username' in session:
        ...
        return render_template('pyemoncms/pyemoncms_login.html')
    ...
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            if user[10] is None:
                ...
                bio = user[10]
            avatar = user[11]
            return render_template('pyemoncms/pyemoncms/user.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey,
                                                            ...
                                                            bio=bio,
                                                            avatar=avatar)
        return redirect(url_for('pyemoncms_login'))
    return render_template('index.html')


@app.route('/pyemoncms_login')
def pyemoncms_login():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
...
def pyemon_node():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            return render_template('pyemoncms/pyemoncms/node.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
...
def pyemon_feeds():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            writeKey = user[3]
            readKey = user[4]
            return render_template('pyemoncms/pyemoncms/feeds.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
...
def pyemon_input():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            return render_template('pyemoncms/pyemoncms/input.html',
                                                            inputs=inputs,
...
def pyemon_vis():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            writeKey = user[3]
            readKey = user[4]
            return render_template('pyemoncms/pyemoncms/vis.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
...
def pyemon_dashboard():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            writeKey = user[3]
            readKey = user[4]
            return render_template('pyemoncms/pyemoncms/dashboard.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
...
def pyemon_myelectric():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            writeKey = user[3]
            readKey = user[4]
            return render_template('pyemoncms/pyemoncms/myelectric.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
...
def pyemon_api():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            writeKey = user[3]
            readKey = user[4]
            return render_template('pyemoncms/pyemoncms/api.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
...
def pyemon_docs():
    if 'username' in session:
        if 'pyEMONCMS_username' in session:
            ...
            writeKey = user[3]
            readKey = user[4]
            return render_template('pyemoncms/pyemoncms/docs.html',
                                                            username=username,
                                                            email=email,
                                                            writeKey=writeKey,
                                                            readKey=readKey)
