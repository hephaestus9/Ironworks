...
from ironworks.tools import convert_bytes
from ironworks import serverTools
from ironworks import feedparser
from modules_lib.plugin_models.newznabSite import NewznabSite
from modules_lib.plugin_models.setting import Setting
...
def xhr_search(site=1):
    if Setting().get_setting_value('search') == '0':
